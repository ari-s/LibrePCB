...
class ProjectLibrary final : public QObject
{
    ...
    private:
        ...
        QSet<library::LibraryBaseElement*> mTemporarySavedElements;
        QSet<library::LibraryBaseElement*> mOriginalSavedElements;
        QSet<library::LibraryBaseElement*> mUpgradedElements;
};
